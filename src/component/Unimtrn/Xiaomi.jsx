...
const Xiaomi = ({ double }) => {
  ...
  const [isRedmiPad, setIsRedmiPad] = useState(false);
  const [isMiPad, setIsMiPad] = useState(false);
  const [isPocoPad, setIsPocoPad] = useState(false);
          ...
          <div className="col-sm-6 offset-3">
            <table className="table">
              ...
              <tbody>
                ...
                {isWatch && <br />}
                {isWatch && <div>⌚ Redmi Watch</div>}
                {allPriceArr.length ? (
                  allPriceArr.map((el, index) => (
                    <div key={index}>
                      {baseFix(el) &&
                        (el.name.indexOf("Redmi Watch") != -1 ||
                          el.name.indexOf("Mi Watch") != -1 ||
                          el.name.indexOf("Mi Portable") != -1) &&
          ...
          <div className="col-sm-6 offset-3">
            <table className="table">
              ...
              <tbody>
                ...
                {isPocoPad && <br />}
                {isPocoPad && <div>📟 Poco Pad</div>}
                {allPriceArr.length ? (
                  allPriceArr.map((el, index) => (
                    <div key={index}>
                      {baseFix(el) &&
                        (el.name.indexOf("POCO Pad") != -1 ||
                          el.name.indexOf("Poco Pad") != -1 ||
                          el.name.indexOf("POCO PAD") != -1) &&
